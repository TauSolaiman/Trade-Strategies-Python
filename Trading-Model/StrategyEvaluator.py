   ...
   '''
    ...
    for i in range(0, len(df['close']-1):
      ...
      if last_buy is None:
        ...
        if strategy_result:
          ...
          last_buy = {
            "index" = i,
            "price" = buy_price
            "desired_profits" = Decimal(initial_profits)
          }
          ...
          next_target_price = last_buy["price"] * last_buy["desired_profts"]
          ...
          if df['low'] < stop_loss_price:
            ...
            last_buy = {
              ...
              "profits" = Decimal(incremental_profits)
            }
      ...
      self.results[model.symbol] = dict(
        returns = round(Decimal(100) * (resulting_balance/starting_balance - Decimal(1.0)), 3),
        buy_times = buy_times
